    ...
    <div class="w3-card-4">
        ...
        <form method="post" class="w3-selection w3-light-grey w3-padding">
            ...
            <label>Guide FirstName:
                <input type="text" name="first" class="w3-input w3-animate-input w3-border w3-round-large"
                       style="width: 30%"><br/>
            </label>
            <label>Guide LastName:
                <input type="text" name="last" class="w3-input w3-animate-input w3-border w3-round-large"
                       style="width: 30%"><br/>
            </label>
